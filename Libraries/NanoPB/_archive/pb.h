...
#include <stddef.h>
#ifdef UNITTEST
	#pragma message("Compiling using a user defined stdbool.h")
	#include "backupStdBool.h"
	//#include <iostream> - DO NOT INCLUDE!  It makes a template specialization break, since <int> is already taken with <bool>
#else
	#pragma message("If you're unit testing, use #define UNITTEST to avoid including stdbool.h")
	#include <stdbool.h>
#endif
#include <string.h>
#endif
